...
execute()
{
  xrun $xrun_opts \
       ...
       -f run.f \
       -top glbl \
       +incdir+"$ref_dir/../../../../zedTestIO.gen/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../zedTestIO.gen/sources_1/bd/system/ipshared/ee60/hdl" \
       +incdir+"../../../../zedTestIO.gen/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"../../../../zedTestIO.gen/sources_1/bd/system/ipshared/ee60/hdl" \
